...
The system SHALL export a Compress function callable from JavaScript.

#### Scenario: JS calls Compress
- **WHEN** JavaScript code calls `Module.Compress(rgba, w, h, threshold, margin, minSavings)`
- **THEN** system returns CompressResult object
...
The system SHALL include NinePatchMeta in result when status is Success.

#### Scenario: Metadata available
- **WHEN** status is Success
- **THEN** result.meta SHALL contain NinePatchMeta with all fields
